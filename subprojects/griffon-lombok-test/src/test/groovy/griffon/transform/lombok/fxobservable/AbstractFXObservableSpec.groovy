...
abstract class AbstractFXObservableSpec<T> extends Specification {
    ...
    protected static List<Map<String, Object>> testData = [
            ...
            [name: "theMap", propertyType: MapProperty, simpleType: Map, simpleValue: [key: 42], propertyValue: FXCollections.observableMap([key: 42]), defaultValue: [:]],
            [name: "theSet", propertyType: SetProperty, simpleType: Set, simpleValue: [42] as Set, propertyValue: FXCollections.observableSet(42), defaultValue: [] as Set],
            [name: "theList", propertyType: ListProperty, simpleType: List, simpleValue: [42], propertyValue: FXCollections.observableArrayList(42), defaultValue: []],
            ...
            [name: "theMapWithDefault", propertyType: MapProperty, simpleType: Map, simpleValue: [key: 42], propertyValue: FXCollections.observableMap([key: 42]), defaultValue: [:]],
            [name: "theSetWithDefault", propertyType: SetProperty, simpleType: Set, simpleValue: [42] as Set, propertyValue: FXCollections.observableSet(42), defaultValue: [42] as Set],
            [name: "theListWithDefault", propertyType: ListProperty, simpleType: List, simpleValue: [42], propertyValue: FXCollections.observableArrayList(42), defaultValue: [42]],
